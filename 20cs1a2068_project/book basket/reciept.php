...
<?php
	...
	<center><button id="print-btn" class="btn btn-warning" type="button" style="width:17%;font-size:2em;color:white;margin-bottom:35px;margin-left: 20px;margin-top: 15px" onclick="window.print();">Download Reciept</button></center>
	<center><a id="print-btn" href="orders.php"><button id="print-btn" class="btn btn-warning" type="button" style="width:10%;font-size:2em;color:white;margin-bottom:35px;margin-left: 20px">Go Back</button></a></center>
